...
&НаКлиенте
Процедура ПостроительЗапроса(Команда)
...
Запрос.Текст="ВЫБРАТЬ
             ...
             |	ВТ_ТаблицаПрайсЛиста.Номенклатура КАК НоменклатураИзФайла
             |ИЗ
...
Попытка
    ...
    СообщениеПользователю = Новый СообщениеПользователю();
      СообщениеПользователю.Текст = "Создан и проведен документ установки цен!" + ДокументУстановкиЦен.Ссылка;
    СообщениеПользователю.Сообщить();
Исключение
