 ...
 Процедура УстановитьВидимость()
	 ...
	 Элементы.ДоговорКонтрагента.Видимость = (ЭтоОплатаПоставщику ИЛИ ЭтоВозвратПокупателю) И КонтрагентЯвляетсяПоставщиком и не ЭтоПереводНаДругойСчет;
	 Элементы.Касса.Видимость = ЭтоСнятиеНаличныхВКассу;
	 Элементы.Получатель.Видимость = НЕ ЭтоСнятиеНаличныхВКассу и не ЭтоПереводНаДругойСчет;
